...
const Login = () => {
  ...
  const { currentUser, isLoading, error, isAuthenticated } = useSelector((state) => state.auth);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigation will be handled by the useEffect when user and isAuthenticated are updated
    } catch (err) {
